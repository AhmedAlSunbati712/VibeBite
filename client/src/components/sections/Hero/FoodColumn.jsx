...
function FoodColumn() {
    return (
        <div className="col-12 col-md-6  px-0 py-0 food-col">
        <div className="food-overlay-text">
          ...
          <h1>Food Cravings</h1>
          <p>Your mood as flavor</p>
          {/* <div className="container mt-4 sign-up-food">
            <p id="sign-up-caption">First time? Let’s match your mood.</p>
            <div className="login-button">
              <button type="button" className="btn btn-primary px-4 hero-sign-up-btn">Sign Up</button>
            </div>
          </div> */}
        </div>
